...
"[project]/app/admin/billing/settings/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SettingsPage() {
    _s();
    const { showNotification } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$Notification$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNotification"])();
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const [saving, setSaving] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [testingConnection, setTestingConnection] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const [stripeApiKey, setStripeApiKey] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [stripePublishableKey, setStripePublishableKey] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [retellApiKey, setRetellApiKey] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [vonageApiKey, setVonageApiKey] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [vonageApiSecret, setVonageApiSecret] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [twilioAccountSid, setTwilioAccountSid] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [twilioAuthToken, setTwilioAuthToken] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    async function loadSettings() {
        ...
        try {
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('billing_settings').select('*').eq('user_id', userData.user.id).single();
            if (data) {
                setSettings(data);
    ...
    async function saveSettings() {
        ...
        try {
            ...
            if (stripeApiKey) {
                encryptedStripeKey = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$stripeInvoiceService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["stripeInvoiceService"].encryptApiKey(stripeApiKey);
            }
            // Encrypt Retell API key if provided
            let encryptedRetellKey = settings.retell_api_key_encrypted;
            if (retellApiKey) {
                encryptedRetellKey = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$stripeInvoiceService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["stripeInvoiceService"].encryptApiKey(retellApiKey);
            }
            ...
            if (vonageApiKey) {
                encryptedVonageKey = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$stripeInvoiceService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["stripeInvoiceService"].encryptApiKey(vonageApiKey);
            }
            if (vonageApiSecret) {
                encryptedVonageSecret = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$stripeInvoiceService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["stripeInvoiceService"].encryptApiKey(vonageApiSecret);
            }
            ...
            if (twilioAccountSid) {
                encryptedTwilioSid = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$stripeInvoiceService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["stripeInvoiceService"].encryptApiKey(twilioAccountSid);
            }
            if (twilioAuthToken) {
                encryptedTwilioToken = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$stripeInvoiceService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["stripeInvoiceService"].encryptApiKey(twilioAuthToken);
            }
            ...
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('billing_settings').upsert(settingsToSave, {
                onConflict: 'user_id'
            });
    ...
    async function testConnection() {
        ...
        try {
            const { data: userData } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.getUser();
            if (!userData.user) throw new Error('Not authenticated');
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$stripeInvoiceService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["stripeInvoiceService"].initialize(userData.user.id);
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$stripeInvoiceService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["stripeInvoiceService"].testConnection();
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$Card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                ...
                                children: [
                                    ...
                                    connectionResult && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "p-4 rounded-lg border ".concat(connectionResult.success ? 'bg-green-50 dark:bg-green-900/20 border-green-200 dark:border-green-800' : 'bg-red-50 dark:bg-red-900/20 border-red-200 dark:border-red-800'),
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "flex items-center",
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    className: "text-sm ".concat(connectionResult.success ? 'text-green-800 dark:text-green-300' : 'text-red-800 dark:text-red-300'),
...
_s(SettingsPage, "pLcQgVHVZj0xQzgLST9tiS+yzbE=", false, function() {
    return [
...
//# sourceMappingURL=_863b3033._.js.map