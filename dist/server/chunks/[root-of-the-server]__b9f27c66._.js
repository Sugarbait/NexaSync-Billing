...
async function POST(request) {
    try {
        ...
        if (authHeader) {
            ...
            const { data: billingUser, error: billingUserError } = await supabaseAdmin.from('billing_users').select('role, is_active').eq('auth_user_id', user.id).single();
        ...
        const { data: newBillingUser, error: billingError } = await supabaseAdmin.from('billing_users').insert({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b9f27c66._.js.map